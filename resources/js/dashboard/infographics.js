window.ASTABAYA = window.ASTABAYA || {};
    ...
    document.addEventListener('DOMContentLoaded', async function() {
        if (!document.getElementById('infographicModal') && !document.querySelector('.infographic-card') && !window.location.pathname.includes('/infographics') && !window.location.pathname.includes('/dashboard')) return;
        const urlParams = new URLSearchParams(window.location.search);
