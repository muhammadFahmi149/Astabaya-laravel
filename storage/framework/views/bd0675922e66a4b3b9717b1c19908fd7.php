      ...
      <div class="card">
        <div class="card-body" style="padding: 15px;">
          <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
            ...
            <!-- Global Year Filter for Triwulanan (hidden by default) -->
            <div id="globalTriwulananFilterContainer" style="display: none; align-items: center; gap: 8px; margin-left: auto;">
              <label for="globalYearFilterTriwulanan" style="margin: 0; font-weight: 500; color: #333; font-size: 13px; white-space: nowrap;"><i class="fas fa-filter me-1"></i>Tahun:</label>
              <select id="globalYearFilterTriwulanan" class="form-control" style="width: auto; min-width: 180px; padding: 8px 12px; font-size: 13px; border-radius: 8px;">
...
<?php endif; ?>
          ...
          <div class="chart-scroll-container">
            <div id="adhbChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
          </div>
        </div>
      </div>
...
<?php endif; ?>
          ...
          <div class="chart-scroll-container">
            <div id="adhkChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
          </div>
        </div>
      </div>
    </div>
...
<?php endif; ?>
          ...
          <div class="chart-scroll-container">
            <div id="distribusiChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
          </div>
        </div>
      </div>
...
<?php endif; ?>
          ...
          <div class="chart-scroll-container">
            <div id="lajuChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
          </div>
        </div>
      </div>
    </div>
...
<?php endif; ?>
            ...
            <div class="chart-scroll-container">
              <div id="filteredChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
            </div>
          </div>
        </div>
      </div>
...
<?php endif; ?>
          ...
          <div class="chart-scroll-container">
            <div id="adhbTriwulananChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
          </div>
        </div>
      </div>
...
<?php endif; ?>
          ...
          <div class="chart-scroll-container">
            <div id="adhkTriwulananChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
          </div>
        </div>
      </div>
    </div>
...
<?php endif; ?>
          ...
          <div class="chart-scroll-container">
            <div id="distribusiTriwulananChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
          </div>
        </div>
      </div>
...
<?php endif; ?>
          ...
          <div class="chart-scroll-container">
            <div id="lajuQtoQChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
          </div>
        </div>
      </div>
    </div>
...
<?php endif; ?>
          ...
          <div class="chart-scroll-container">
            <div id="lajuYtoYChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
          </div>
        </div>
      </div>
...
<?php endif; ?>
          ...
          <div class="chart-scroll-container">
            <div id="lajuCtoCChart" class="chart-responsive" style="width: 100%; height: 380px;"></div>
          </div>
        </div>
      </div>
    </div>
...
<?php endif; ?>
            ...
            <div class="chart-scroll-container">
              <div id="filteredChartTriwulanan" class="chart-responsive" style="width: 100%; height: 380px;"></div>
            </div>
          </div>
        </div>
      </div>
...
window.APP_CONFIG = {
  ...
  isAuthenticated: <?php if(auth()->guard()->check()): ?> true <?php else: ?> false <?php endif; ?>,
  loginUrl: '<?php echo e(route("login")); ?>'
};
</script>

<?php echo app('Illuminate\Foundation\Vite')(['resources/css/dashboard/pdrb-pengeluaran.css', 'resources/js/dashboard/pdrb-pengeluaran.js']); ?>
<?php $__env->stopPush(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\astabaya\resources\views/dashboard/indikator/pdrb_pengeluaran.blade.php ENDPATH**/ ?>