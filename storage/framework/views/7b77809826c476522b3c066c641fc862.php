...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <form id="login-form" method="POST" action="<?php echo e(route('login-form')); ?>">
            <?php echo csrf_field(); ?>
        ...
        <div class="register-link">Belum memiliki akun? <a href="<?php echo e(route('signup')); ?>">Daftar</a></div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Astabaya-laravel\resources\views/accounts/login.blade.php ENDPATH**/ ?>