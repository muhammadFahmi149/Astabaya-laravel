...
window.APP_CONFIG = {
  routes: {
    ...
    inflasiKomoditasTree: '<?php echo e(route("api.inflasi-komoditas-tree")); ?>',
    login: '<?php echo e(route("login")); ?>'
  },
  isAuthenticated: <?php if(auth()->guard()->check()): ?> true <?php else: ?> false <?php endif; ?>
};
</script>
<?php echo app('Illuminate\Foundation\Vite')(['resources/css/dashboard/inflasi.css', 'resources/js/dashboard/inflasi.js']); ?>
<?php $__env->stopPush(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\astabaya\resources\views/dashboard/indikator/inflasi.blade.php ENDPATH**/ ?>