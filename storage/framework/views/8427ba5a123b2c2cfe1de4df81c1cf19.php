...
<div class="news-page">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        <?php if(isset($search_query) || isset($selected_category)): ?>
                            Menampilkan: <span class="badge bg-primary"><?php echo e($filtered_count ?? 0); ?></span> dari <span class="badge bg-secondary"><?php echo e($totalNews ?? 0); ?></span> berita
                        <?php else: ?>
                            Total: <span class="badge bg-primary"><?php echo e($totalNews ?? 0); ?></span> berita
                        <?php endif; ?>
                    </p>
                </div>
                <a href="<?php echo e(route('news')); ?>" class="btn btn-primary">
    ...
    <!-- Filter & Search -->
    <form method="GET" action="<?php echo e(route('news')); ?>" id="filterForm">
        <div class="row mb-4">
            ...
            <div class="col-md-3 mb-3 mb-md-0">
                <select class="form-select shadow-sm" id="categoryFilter" name="category_id" onchange="document.getElementById('filterForm').submit();">
                    ...
                    <?php if(isset($available_categories)): ?>
                        <?php $__currentLoopData = $available_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category['id']); ?>" <?php echo e((isset($selected_category) && $selected_category == $category['id']) ? 'selected' : ''); ?>>
            ...
            <div class="col-md-3">
                <select class="form-select shadow-sm" id="sortFilter" name="sort" onchange="document.getElementById('filterForm').submit();">
                    <option value="latest" <?php echo e((isset($sort) && $sort == 'latest') ? 'selected' : ''); ?>>Terbaru</option>
                    <option value="oldest" <?php echo e((isset($sort) && $sort == 'oldest') ? 'selected' : ''); ?>>Terlama</option>
                </select>
            </div>
        </div>
    </form>
    ...
    <div class="row" id="newsContainer">
        <?php if(isset($dataNews) && $dataNews->count() > 0): ?>
            <?php $__currentLoopData = $dataNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row d-none d-md-flex align-items-center">
                            <div class="col-md-3">
                                <?php if($item->picture_url): ?>
                                    <img src="<?php echo e($item->picture_url); ?>" alt="<?php echo e($item->title); ?>" 
                                         class="img-fluid rounded shadow-sm" 
                                         style="width: 100%; height: 200px; min-height: 200px; object-fit: cover; cursor: pointer;"
                                         onclick="showNewsModal(<?php echo e($index); ?>)">
                                <?php else: ?>
                            ...
                            <div class="col-md-9">
                                <h6 class="card-title mb-2 fw-bold" style="cursor: pointer; min-height: 48px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;" onclick="showNewsModal(<?php echo e($index); ?>)"><?php echo e($item->title); ?></h6>
                                <div class="mb-2">
                                    <?php if($item->category_name): ?>
                                        <span class="badge bg-primary me-2"><?php echo e($item->category_name); ?></span>
                                    <?php endif; ?>
                                    <?php if($item->release_date): ?>
                                        <span class="badge bg-info">
                                            <i class="bi bi-calendar"></i> <?php echo e(\Carbon\Carbon::parse($item->release_date)->format('d F Y')); ?>
                                ...
                                <p class="card-text text-muted mb-3" style="min-height: 60px; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;">
                                    <?php echo e(\Illuminate\Support\Str::words(strip_tags($item->content ?? ''), 30, '...')); ?>
                            ...
                            <div class="col-12">
                                <div class="d-flex gap-2 align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="card-title mb-1 fw-bold" style="font-size: 0.9rem; cursor: pointer; min-height: 40px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;" onclick="showNewsModal(<?php echo e($index); ?>)"><?php echo e($item->title); ?></h6>
                                        <div class="mb-1">
                                            <?php if($item->category_name): ?>
                                                <span class="badge bg-primary me-1" style="font-size: 0.7rem;"><?php echo e($item->category_name); ?></span>
                                            <?php endif; ?>
                                            <?php if($item->release_date): ?>
                                                <span class="badge bg-info" style="font-size: 0.7rem;">
                                                    <i class="bi bi-calendar"></i> <?php echo e(\Carbon\Carbon::parse($item->release_date)->format('d M Y')); ?>
                                        ...
                                        <p class="card-text text-muted mb-2" style="font-size: 0.85rem; min-height: 40px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                                            <?php echo e(\Illuminate\Support\Str::words(strip_tags($item->content ?? ''), 20, '...')); ?>
    ...
    <!-- Pagination -->
    <?php if(isset($dataNews) && is_object($dataNews) && method_exists($dataNews, 'hasPages') && $dataNews->hasPages()): ?>
    <nav aria-label="Page navigation" class="mt-4">
        <ul class="pagination justify-content-center">
            <?php if($dataNews->onFirstPage()): ?>
            <li class="page-item disabled">
                <span class="page-link"><i class="bi bi-chevron-left"></i> Previous</span>
            </li>
            <?php else: ?>
            <li class="page-item">
                <a class="page-link" href="<?php echo e($dataNews->appends(request()->query())->previousPageUrl()); ?>">
                    <i class="bi bi-chevron-left"></i> Previous
                </a>
            </li>
            <?php endif; ?>

            <?php $__currentLoopData = $dataNews->getUrlRange(max(1, $dataNews->currentPage() - 2), min($dataNews->lastPage(), $dataNews->currentPage() + 2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($page == $dataNews->currentPage()): ?>
                <li class="page-item active">
                    <span class="page-link"><?php echo e($page); ?></span>
                </li>
                <?php else: ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo e($dataNews->appends(request()->query())->url($page)); ?>"><?php echo e($page); ?></a>
                </li>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

            <?php if($dataNews->hasMorePages()): ?>
            <li class="page-item">
                <a class="page-link" href="<?php echo e($dataNews->appends(request()->query())->nextPageUrl()); ?>">
        ...
        <p class="text-center text-muted small mt-2">
            Menampilkan <?php echo e($dataNews->firstItem() ?? 0); ?> sampai <?php echo e($dataNews->lastItem() ?? 0); ?> dari <?php echo e($filtered_count ?? $dataNews->total()); ?> berita
        </p>
    </nav>
    <?php endif; ?>
</div>
...
<div id="newsDataContainer" style="display: none">
    <?php if(isset($dataNews) && $dataNews->count() > 0): ?>
        ...
        <div class="news-data"
             ...
             data-date="<?php echo e($item->release_date ? \Carbon\Carbon::parse($item->release_date)->format('d F Y') : 'N/A'); ?>"
             data-image="<?php echo e(e($item->picture_url ?? '')); ?>">
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
</div>
...
<script>
    ...
    function showNewsModal(index) {
        ...
        if (modalShareBtn) {
            ...
            const newsUrl = `<?php echo e(route('news')); ?>?news=${newsId}`;
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Astabaya-laravel\resources\views/dashboard/news.blade.php ENDPATH**/ ?>