...
<script>
    ...
    async function showInfographicDetail(id) {
        ...
        if (downloadBtn) {
            const downloadUrl = `<?php echo e(url('/infographics/download')); ?>/${item.id}`;
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Astabaya-laravel\resources\views/dashboard/infographics.blade.php ENDPATH**/ ?>